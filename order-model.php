...
<div class=" register" >
                <div class="row">
                    <div class="col-md-3 register-left">
                        ...
                        <h3>Selamat Datang di Laundry lompat</h3>
                        
                        <a href="Login.php"><input type="submit" name="" value="Masuk"/></a><br/>
                    </div>
                    <div class="col-md-9 register-right">
                                <h3 class="register-heading">Buat Pesanan</h3>
                                <div class="row register-form">
                                    <div class="col-md-12">
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                        	<label>No Telepon</label><span id="phone1"></span>
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                        	<label>Tanggal Pengambilan</label><span id="P_date1"></span>
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                        	<label>Tanggal Pengiriman</label><span id="D_date1"></span>
                                       ...
                                       <div class="col-md-6">
                                         <div class="form-group">
                                            <select class="form-control" id="Type" onchange="Type1()" required="">
                                                <option class="hidden"  selected >Jenis Layanan</option>
                                               <?php $Show1=Serv_Type();
									                $count='0';
